...
config = {
    'netG': tune.choice(['large_netG_normalized', 'large_netG', 'small_netG_normalized', 'small_netG']),
    'netD': tune.choice(['large_netD_normalized', 'large_netD', 'small_netD_normalized', 'small_netD']),
    'batch_size': tune.choice([8, 128]),
    'n_epochs': 200,
    'lrG': tune.choice([4e-3, 4e-4]),
    'lrD': tune.choice([4e-3, 4e-4]),
}
